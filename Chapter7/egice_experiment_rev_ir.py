...
EXP0 = []
EXP1 = [EXP_POSTPROCESS]
EXP2 = [EXP_POSTPROCESS, EXP_DUPLICATES]
EXP3 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT]
EXP4 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT, EXP_DATA_AND_OR]
EXP5 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT, EXP_DATA_AND_OR, EXP_ATOM]
EXP6 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT,
        EXP_DATA_AND_OR, EXP_ATOM, EXP_EXPRESSION]
EXP7 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT,
        EXP_DATA_AND_OR, EXP_ATOM, EXP_EXPRESSION, EXP_LOOP]
EXP8 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT, EXP_ATOM]
EXP9 = [EXP_POSTPROCESS, EXP_DUPLICATES, EXP_UNIT, EXP_ATOM, EXP_EXPRESSION]
EXP10 = [EXP_POSTPROCESS, EXP_DUPLICATES,
         EXP_UNIT, EXP_ATOM, EXP_EXPRESSION, EXP_LOOP]

EXPERIMENTS = [EXP0, EXP1, EXP2, EXP3, EXP4,
               EXP5, EXP6, EXP7, EXP8, EXP9, EXP10]
EXPERIMENT_NAMES = ['base', 'postprocess', 'postprocess_duplicates', 'unit', 'u_ao',
                    'u_ao_atom', 'u_ao_at_expr', 'u_ao_at_ex_loop', 'u_atom', 'u_at_expr', 'u_at_ex_loop']
